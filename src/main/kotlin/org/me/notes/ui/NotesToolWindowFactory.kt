...
import org.me.notes.storage.NotesChangedListener

class NotesToolWindowFactory : ToolWindowFactory, DumbAware {
    override fun createToolWindowContent(project: Project, toolWindow: ToolWindow) {
        addContent(toolWindow.contentManager, project)

        project.messageBus.connect().subscribe(NotesChangedListener.Companion.NOTES_CHANGED_TOPIC, object :
            NotesChangedListener {
